...
<h4> DOH-ROXII-MSDRS-SOP-01 Form3 Rev0</h4>
                    ...
                    <h4>Prepared By: </h4>
<p style="margin-left:100px;"><u>{{ Auth::user()->fname }} {{ Auth::user()->lname }}</u>
<br> {{ $des }}</p>
...
<p>TRN: {{ $TRN }}</p>
        ...
        <h5 style="margin-left:10px;">Printed By:</h5>
                ...
                <span style="margin-left:30px">     ({{ Section::find(Auth::user()->section)->description }}) </span><br> 
                <span style="margin-left:30px">  {{ Auth::user()->fname }} {{ Auth::user()->lname }} </span><br>
         </div>
                    </div>
        <div class="col-sm-6">
