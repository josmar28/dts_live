    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <hr />
                <textarea name="remarks" class="form-control" id="return_remarks" rows="7" style="resize: vertical;" placeholder="Please enter your remark(s) of return..." required></textarea>
            </div>
            <div class="modal-footer">
                <button class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
...
<div class="modal fade" role="dialog" id="transmittal_modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body transmittal_body">
            </div><!-- /.modal-content -->
        </div>
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h4 class="text-success"><i class="fa fa-book"></i> Remarks</h4>
                <hr />
                <textarea name="remarks" class="form-control" id="accept_remarks" rows="7" style="resize: vertical;" placeholder="Please enter your remark(s) of accept..." required></textarea>
            </div>
            <div class="modal-footer">
                <button class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
